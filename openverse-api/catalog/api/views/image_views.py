...
{SearchMedia.search_description}"""  # noqa
    ...
    @swagger_auto_schema(
        ...
        code_examples=[{"lang": "Bash", "source": image_search_curl}],
    )
...
{RelatedMedia.recommendations_read_description}"""  # noqa
    ...
    def get(self, request, identifier, format=None):
        ...
        serialized_related = ImageSerializer(related, many=True, context=context).data
        response_data = {
    ...
    def get(self, request, identifier, format=None):
        ...
        if params.data["embed_metadata"]:
            ...
            try:
                ...
                log.error(f"Failed to add XMP metadata to {image_record.identifier}")
                log.error(e)
...
class OembedView(APIView):
    ...
    @swagger_auto_schema(
        ...
        code_examples=[{"lang": "Bash", "source": oembed_list_bash}],
    )
...
{refer_sample}"""  # noqa
    ...
    @swagger_auto_schema(
        operation_id="images_report_create",

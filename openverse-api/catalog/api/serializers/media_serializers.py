...
class MediaSearchQueryStringSerializer(serializers.Serializer):
    ...
    page = serializers.IntegerField(
        label="page number", help_text="The page number to retrieve.", default=1
    )
...
class AboutMediaSerializer(serializers.Serializer):
    ...
    source_name = serializers.CharField(help_text="The source of the media.")
    display_name = serializers.CharField(help_text="The name of content provider.")
    source_url = serializers.CharField(help_text="The actual URL to the `source_name`.")
...
class ProxiedImageSerializer(serializers.Serializer):
    ...
    full_size = serializers.BooleanField(
        default=False, help_text="If set, do not thumbnail the image."
    )

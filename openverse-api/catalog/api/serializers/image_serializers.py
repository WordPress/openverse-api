...
class OembedResponseSerializer(serializers.Serializer):
    ...
    version = serializers.IntegerField(help_text="The image version.")
    type = serializers.CharField(help_text="Type of data.")
    width = serializers.IntegerField(help_text="The width of the image in pixels.")
    height = serializers.IntegerField(help_text="The height of the image in pixels.")
    title = serializers.CharField(help_text="The name of image.")
    author_name = serializers.CharField(help_text="The name of author for image.")
    author_url = serializers.URLField(help_text="A direct link to the author.")
...
class OembedSerializer(serializers.Serializer):
    ...
    url = serializers.URLField(help_text="The link to an image.")
...
class AboutImageSerializer(AboutMediaSerializer):
    ...
    image_count = serializers.IntegerField(help_text="The number of images.")
